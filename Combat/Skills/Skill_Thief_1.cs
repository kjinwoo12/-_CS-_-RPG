...
public class Skill_Thief_1 : Skill
{
    public Skill_Thief_1(Character owner)
        : base(owner, "Shadow Slash", "한 명의 적을 강력하게 공격합니다.")
    {
    }
    ...
    public override void OnUse(List<Character> targets)
    {
        foreach (Character target in targets)
        {
            ...
            attackOrder.damage = (int)(attackOrder.damage * 2.1f);
            ...
            Thread.Sleep(1000);
            Console.WriteLine();
            Console.WriteLine($"넌 이미 죽어있다... {skillName}!");
            Thread.Sleep(2000);
        }
