...
public class Skill_Archer_1 : Skill
{
    public Skill_Archer_1(Character owner)
        : base(owner, "마법의 수정화살", "큰 얼음 화살로 한 명의 적을 강력하게 공격합니다.")
    {
    }
    ...
    public override void OnUse(List<Character> targets)
    {
        foreach (Character target in targets)
        {
            ...
            Thread.Sleep(1000);
            Console.WriteLine();
            Console.WriteLine($"화살 한발로 세상을 평정해주지... {skillName}!");
            Thread.Sleep(2000);
