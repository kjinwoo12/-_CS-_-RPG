...
public class Skill_Archer_2 : Skill
{
    public Skill_Archer_2(Character owner)
        : base(owner, "부패의 사슬", "두명의 적을 강력하게 공격합니다.")
    {
    }
    ...
    public override void OnUse(List<Character> targets)
    {
        foreach (Character target in targets)
        {
            ...
            attackOrder.damage = (int)(attackOrder.damage * 1.4f);
        ...
        Console.WriteLine();
        Console.WriteLine($"도망쳐봐야 소용없다... {skillName}!");
        Thread.Sleep(2000);
    ...
    public override List<Character> SelectTargetsFrom(List<Character> targets)
    {
        ...
        int maxTargetCount = Math.Min(2, validTargets.Count); // 여기서 맞는 적의 수를 표현하면 되겠습니다.
