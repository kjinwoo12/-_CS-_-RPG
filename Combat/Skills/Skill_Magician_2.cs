...
public class Skill_Magician_2 : Skill
{
    public Skill_Magician_2(Character owner)
        : base(owner, "풀려난 힘", "암흑의 구체를 한 명의 적에게 날려 공격합니다.")
    {
    }
    ...
    public override void OnUse(List<Character> targets)
    {
        foreach (Character target in targets)
        {
            ...
            Thread.Sleep(1000);
            Console.WriteLine();
            Console.WriteLine($"이게 너의 한계다!    {skillName}!");
            Thread.Sleep(2000);
